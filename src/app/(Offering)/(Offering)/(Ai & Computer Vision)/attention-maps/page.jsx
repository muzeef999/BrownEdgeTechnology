      ...
      {!loader ? (
        ...
        <div>
          ...
          <div className="container my-3" data-aos="fade-up">
            ...
            <div className="row">
              <div className="col-md-6">
                ...
                <p className="p">In this project, we seek to reduce computation and memory overheads of various backbone networks for various applications ranging from detection, tracking, pose estimation, etc.</p>
              ...
              <div className="col-md-6 d-flex justify-content-center align-items-center" data-aos="fade-left">
                <img src="/attentionmap.webp" style={{ width: "100%", borderRadius: "20px", height: "400px", objectFit: "cover" }} />
              </div>
            </div>
          </div>
          ...
          <div className="container" data-aos="fade-up">
            ...
            <p className="p">It has various applications with simple and minimal changes to the existing backbone networks for various applications.</p>
          </div>
        </div>
      )}
    </div>
