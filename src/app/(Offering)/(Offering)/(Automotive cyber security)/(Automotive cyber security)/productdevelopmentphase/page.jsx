          ...
          <div className="container" style={{overflow:"hidden"}}>
            <div className="row">
              <div className="col-md-6" data-aos="fade-right">
                ...
                <ol type='1'>
                  <li>
                    <h6 style={{ color: "#964B00" }}>Detailed Design and Planning</h6>
                  </li>
                  <ul type="disc">
                  ...
                  <li>
                    <h6 style={{ color: "#964B00" }}>Prototyping and Proof of Concept</h6>
                  </li>
                  <ul type="disc">
                  ...
                  <li>
                    <h6 style={{ color: "#964B00" }}>Implementation and Coding</h6>
                  </li>
                  <ul type="disc">
                  ...
                  <li>
                    <h6 style={{ color: "#964B00" }}>System Integration</h6>
                  </li>
                  <ul type="disc">
              ...
              <div className="col-md-6 d-flex justify-content-center align-items-center" data-aos="fade-left">
                <img src="/productdev.webp" style={{ width: "100%", borderRadius: "20px" }} />
              </div>
            </div>
            ...
            <div data-aos="fade-up">
              <ol type='1' start="5">
                <li>
                  <h6 style={{ color: "#964B00" }}>Testing and Quality Assurance</h6>
                </li>
                <ul type="disc">
                ...
                <li>
                  <h6 style={{ color: "#964B00" }}>Validation and Verification</h6>
                </li>
                <ul type="disc">
                ...
                <li>
                  <h6 style={{ color: "#964B00" }}>Documentation and Training</h6>
                </li>
                <ul type="disc">
            ...
            <ul className='product-development' data-aos="fade-up">
              <li>
