        ...
        <div>
          <div className="position-relative video-container" data-aos="fade-in">
            ...
            <div className="container sec position-absolute top-50 start-50 translate-middle text-center">
              <h1 style={{ color: "#FFF", fontWeight: "500" }} className="about-data" data-aos="fade-up">
          ...
          <div className="container" data-aos="fade-up">
            <div className="row">
              ...
              <div className="col-md-6">
                <ol type='1'>
                  <li> 
                    <h6 style={{ color: "#964B00" }}>Threat Identification</h6>
                    <ul type="disc">
                  ...
                  <li> 
                    <h6 style={{ color: "#964B00" }}>Vulnerability Analysis</h6>
                    <ul type="disc">
                  ...
                  <li> 
                    <h6 style={{ color: "#964B00" }}>Risk Assessment</h6>
                    <ul type="disc">
                  ...
                  <li> 
                    <h6 style={{ color: "#964B00" }}>Mitigation Planning</h6>
                    <ul type="disc">
                  ...
                  <li> 
                    <h6 style={{ color: "#964B00" }}>Continuous Monitoring</h6>
                    <ul type="disc">
              ...
              <div className="col-md-6 d-flex justify-content-center align-items-center">
                <img src="/tara.webp" style={{ width: "100%", borderRadius: "20px" }} data-aos="fade-left"/>
              </div>
            </div>

            <h4 data-aos="fade-up">Key Outputs of the TARA Method</h4>
            <ul className='tara' data-aos="fade-up">
              <li>
            ...
            <p data-aos="fade-up">
              At BrownEdge Technology, the TARA method is an essential part of our commitment to cybersecurity. By systematically identifying and addressing threats and vulnerabilities, we ensure our automotive systems are secure, reliable, and resilient against potential attacks.
            </p>
          </div>
        </div>
      )}
