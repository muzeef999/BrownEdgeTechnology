        ...
        <div>
          ...
          <div className="container my-3" data-aos="fade-up">
            ...
            <div className="row">
              <div className="col-md-12">
                ...
                <p className='p'>
                  At BrownEdge Technology, the cybersecurity concept phase is integral to ensuring that our automotive systems are designed with security in mind from the very beginning. This phase focuses on identifying potential threats, defining security requirements, and establishing a robust security architecture to protect our systems throughout their lifecycle.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container" data-aos="fade-up">
            <div className="row">
              ...
              <ol type='1'>
                <li>
                  <h6 style={{ color: "#964B00" }}>Threat Analysis and Risk Assessment (TARA)</h6>
                </li>
                <ul type="disc">
                ...
                <li>
                  <h6 style={{ color: "#964B00" }}>Security Requirements Definition</h6>
                </li>
                <ul type="disc">
                ...
                <li>
                  <h6 style={{ color: "#964B00" }}>Security Architecture Design</h6>
                </li>
                <ul type="disc">
              ...
              <div class="col-md-6 d-flex justify-content-center align-items-center"><img src="/tara.webp" style={{width:"100%",borderRadius:"20px",height:"500px",objectFit:"cover"}}/></div>
            </div>
            <br/>

            <h4>Key Outputs of the Cybersecurity Concept Phase</h4>
            <ul className='cyber' data-aos="fade-up">
              <li>
